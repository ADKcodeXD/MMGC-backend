...
export default class ActivityController {
  ...
  async saveDay(@Body() dayParams: DayParams) {
    ...
    const newDay: DayParams = new DayParamsEntity()
  ...
  @PutMapping('/sortDay', [Validtor('body', sortParamsSchemaValidate)])
  @Auth([ROLE.ADMIN, ROLE.SUBADMIN, ROLE.COMMITTER, ROLE.GROUPMEMBER], '/sortDay')
  async sortDay(@Body() sortParams: SortParams) {
    const flag = await this.dayService.updateDaySort(sortParams)
